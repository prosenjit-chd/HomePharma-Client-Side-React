        ...
        <div className="mt-5">
            ...
            <Col xs="12" md="12" lg="12">
                ...
                <Row xs={1} md={2} lg={2} className= "g-4 mb-4"> 
                    ...
                    <Card className="h-100 cart-font">
                        <Card.Img variant="top" src="https://scontent.fdac14-1.fna.fbcdn.net/v/t1.6435-9/58543689_804626263252937_36605903184592896_n.jpg?_nc_cat=106&ccb=1-5&_nc_sid=09cbfe&_nc_ohc=GlrgdRh3Zb8AX8almTH&_nc_ht=scontent.fdac14-1.fna&oh=f7a8f670497f39e26b38be61da8bfae8&oe=6192823D" />
                        <Card.Body>
